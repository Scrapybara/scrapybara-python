...
class GenerateScriptNonStreamingResponse(BaseModel):
    """
    GenerateScriptNonStreamingResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the generated script.")
    streaming: StrictBool
    __properties: ClassVar[List[str]] = ["id", "streaming"]
