...
class ScriptManagementApi:
    ...
    def delete_script(
        ...
        :param script_id: Unique identifier of the script to be deleted. (required)
        :type script_id: str
    ...
    def _delete_script_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/scripts/{script_id}',
    ...
    def get_script(
        ...
        :param script_id: Unique identifier of the script. (required)
        :type script_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_script_serialize(
            script_id=script_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
